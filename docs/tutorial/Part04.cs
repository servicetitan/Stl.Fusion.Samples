...
namespace Tutorial
{
    public static class Part04
    {
        ...
        {
            [ComputeMethod(KeepAliveTime = 1)] // Setting KeepAlive time to 1
        ...
        public static async Task UseCalculator3()
        {
            ...
            // We set ComputedOptions.KeepAliveTime to 1s, we need to
            // wait at least this time to make sure the entry gets evicted
            // from RAM.
        ...
        public static async Task UseCalculator4()
        {
            ...
            // Now let's pull the computed instance that represents the result.
